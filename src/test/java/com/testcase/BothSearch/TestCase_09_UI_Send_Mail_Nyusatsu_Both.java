...
public class TestCase_09_UI_Send_Mail_Nyusatsu_Both extends TestHelper { // 入札案件配信アドレス
	...
	public void TC_02_Check_Text_PlaceHolder() throws InterruptedException {
		Assert.assertEquals(both.getPlaceHolder(txtMail), Constant.TEXT_PLACEHOLDER_MAIL);
	}

	@Test
	public void TC_03_Input_Max_Number_Textboxs_Mail() throws InterruptedException {
		Assert.assertEquals(both.inputMaxNumTextbox(100, 49, btnAddMail, childMailOR, 92, false, true), true);
	}

	@Test
	public void TC_04_Input_Max_Lenght_Textbox_Mail() throws InterruptedException {
		login.clickTabMenu("3");
		Assert.assertEquals(both.maxLenghtTextbox(txtMail, Constant.TEXT_110, Constant.TEXT_100), true);
	}
	...
	public void TC_06_Show_Popup_Warning_When_Click_Checkbox_UnsendMail() throws InterruptedException {
		Assert.assertEquals(both.showPopupSendMail(), true);
		both.closePopup("Mail");
	}

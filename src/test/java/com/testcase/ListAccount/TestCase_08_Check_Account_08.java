...
public class TestCase_08_Check_Account_08 extends TestHelper {
	...
	@Test
	public void TC_01_Account08_Login_Sucess() throws Exception {
		login.login(Constant.LIST_USERNAME[7], Constant.LIST_PASSWORD[7]);
	...
	@Test // 1. BUDGET PAGE
	public void TC_02_Account08_Open_Page_Budget_Success() throws InterruptedException {
		login.clickTabMenu("1");
		Assert.assertEquals(DriverUtils.getDriver().getCurrentUrl(), Constant.URL_HOME + Constant.URL_BUDGET);
	}

	@Test
	public void TC_03_Account08_List_Item_Start_Year() throws InterruptedException {
		try {
	...
	@Test
	public void TC_04_Account08_Time_Search_End_Year_Budget() throws InterruptedException {
		try {
	...
	@Test
	public void TC_05_Account08_Value_Droplist_Time_Search_Start_Year_Budget() throws InterruptedException {
		try {
	...
	@Test
	public void TC_06_Account08_Value_Droplist_Time_Search_End_Year_Budget() throws InterruptedException {
		try {
	...
	@Test
	public void TC_07_Account08_Un_Favorite_All_Item_In_Page_Favorite_Budget() throws InterruptedException {
		budget.unFavorite();
		login.clickTabMenu("1");
	...
	@Test
	public void TC_08_Account08_Show_Result_Budget_Success() throws InterruptedException {
	...
	@Test
	public void TC_09_Account08_Favorite_Success() throws InterruptedException {
	...
	public void TC_10_Account08_Open_Success_Anken_Page() throws InterruptedException {
	...
	@Test
	public void TC_11_Account08_Open_Anken_Yotei_Success() throws InterruptedException {
	...
	@Test
	public void TC_12_Account08_Delete_Anken_Yotei_Success() throws InterruptedException {
	...
	@Test
	public void TC_13_Account08_Open_Anken_Both() throws InterruptedException {
	...
	@Test
	public void TC_14_Account08_Delete_Anken_Both_Success() throws InterruptedException {
	...
	@Test // 3. PAGE_YOTEI
	public void TC_15_Account08_Open_Success_Yotei_Page() throws InterruptedException {
		login.clickTabMenu("2");
		Assert.assertEquals(DriverUtils.getDriver().getCurrentUrl(), Constant.URL_HOME + Constant.URL_YOTEI);
	}

	@Test
	public void TC_16_Account08_Download_File_CSV_Yotei_Success() throws InterruptedException, IOException {
		yotei.delete_File();
	...
	@Test
	public void TC_17_Account08_Bookmark_Item_Yotei_Success() throws InterruptedException, IOException {
	...
	@Test // 4. PAGE_BOTH
	public void TC_18_Account08_Open_Success_Both_Page() throws InterruptedException {
	...
	@Test
	public void TC_19_Account08_Download_File_CSV_Both_Success() throws InterruptedException, IOException {
		both.delete_File();
	...
	@Test
	public void TC_20_Account08_Bookmark_Item_Both_Success() throws InterruptedException, IOException {
	...
	public void TC_21_Account08_Download_File_CSV_Anken_Yotei_Success() throws InterruptedException, IOException {
		anken.delete_File();
		both.scrollToTop(0, 250);
		login.clickTabMenu("5");
		anken.clickTabMenuAnken("1");
	...
	@Test
	public void TC_22_Account08_Download_File_CSV_Anken_Both_Success() throws InterruptedException, IOException {
		anken.delete_File();
		anken.clickTabMenuAnken("2");
		anken.selectValueYearBoth(Constant.SELECT_YEAR_ANKEN_BOTH);
		anken.downloadAnken();

...
public class Constant {
	...
	// Tab menu
	public static final String URLBOTH = "usermenu/both_item_search/";
	public static final String URLYOTEI = "usermenu/yotei_search/";
	public static final String URLBUDGET = "usermenu/budget_search/";
	public static final String URLBUDGET_TRIAL = "usermenu/guide_budget/";
	public static final String URLYOTEIU_TRIAL = "usermenu/guide_predict/";
	public static final String URLANKEN = "usermenu/bookmark_anken/";
